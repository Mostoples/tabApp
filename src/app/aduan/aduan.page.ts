...
export class AduanPage implements OnInit {
  ...
  send() {
    ...
    this.isiEmail2 = this.isiEmail + '<br>' + this.namae + this.user + this.ide + this.prodie + this.fakultase + this.warn + this.platformStr + this.model + this.deviceVersion + this.warn2;
